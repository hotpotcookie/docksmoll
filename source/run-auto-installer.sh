...
ln -snf /usr/share/zoneinfo/$CONTAINER_TIMEZONE /etc/localtime && echo $CONTAINER_TIMEZONE > /etc/timezone & wait
#----------
...
apt-cache policy docker-ce & wait; echo -e "----------------------------------------- ${GREEN}(installing docker)${ENDCOLOR}"
